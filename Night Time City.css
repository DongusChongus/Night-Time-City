...
#app-mount .popout-APcvZm:before {
  content: "";
...
#app-mount .guilds-1SWlCJ .tutorialContainer-11ICd5 .childWrapper-anI2G9 {
  background: var(--gradient);
  background-color: transparent;
}
#app-mount .guilds-1SWlCJ .tutorialContainer-11ICd5 .listItem-2Ig28I:first-child .wrapper-1BJsBx:before {
  content: "";
  border-radius: 50%;
  position: absolute;
...
#app-mount .guilds-1SWlCJ .tutorialContainer-11ICd5 .listItem-2Ig28I:first-child .wrapper-1BJsBx.selected-bZ3Lue:before {
  border-radius: 30%;
}
#app-mount .guilds-1SWlCJ .tutorialContainer-11ICd5 .homeIcon-AaowEC {
  display: none;
}
